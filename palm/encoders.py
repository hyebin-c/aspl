...
class AudioEncoder(nn.Module):
    def __init__(self, audioenc_name:str, d_in: int, d_out: int, sample_rate: int, window_size: int,
            ...
            use_precomputed_melspec: bool, pretrained_audioencoder_path: str,
            spectral: bool = False, prompt_audio_dim: int = 0, prompt_audio_blocks: list = []) -> None:
        super().__init__()
        ...
        self.base = audio_encoder(
            ...
            spectral=spectral, token=prompt_audio_dim, structural=prompt_audio_blocks)
